...
async def lifespan(app: FastAPI):
    ...
    # Warm-up embedding provider in the background
    # so the first query is faster.
    try:
...
app = FastAPI(
    ...
    description=(
        "Sovereign AI Workbench — secure document processing, "
        "OCR, RAG and agents (SIH 2026, SIH117)."
    ),
    lifespan=lifespan,
)
